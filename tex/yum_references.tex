...
%
%     Provides the References section of the manual.
%
%-------------------------------------------------------------------------------
...
\label{sec:yumreferences}
   ...
   \href{mailto:yoshimi-request@freelists.org}{yoshimi-request@freelists.org}
   or by visiting: \url{http://www.freelists.org/list/yoshimi}.
   To post to the list, email to:
   \href{mailto:yoshimi@freelists.org}{yoshimi@freelists.org} The archive of
   the old SourceForge mailing list is found
