...
\label{sec:vector}
   ...
   Vector load and save work from the command-line, for a complete vector
...
\label{subsection:vector_basics}
   ...
   Setup is per MIDI channel, so one can have totally different vector
   behaviour on, say, channel 1 and channel 5.
