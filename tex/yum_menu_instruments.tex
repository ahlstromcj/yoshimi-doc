...
%  \includegraphics[scale=0.75]{1.3.9/instruments_show_stored.png}
   \includegraphics[scale=0.75]{2.0/Instruments.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.0/LoadExternInstrument.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.0/SaveExternInstrument.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.2.2/ClearInstrument.png}
   \caption{Clear Instrument Dialog}
   \label{fig:clear_instrument_dialog}
\end{figure}
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.2.2/ClearPart.png}
