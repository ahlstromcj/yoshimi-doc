...
\label{subsubsec:menu_yoshimi_new_instance}
   ...
   MIDI.
%  Not too useful, but we should test that sometime.
...
%  \includegraphics[scale=0.75]{1.4.1/SettingsMain.png}
   \includegraphics[scale=0.5]{2.3.0/settings.png}
...
\end{figure}
   ...
   some older versions of Yoshimi don't recognise uncompressed
...
%  \includegraphics[scale=0.75]{1.5.0/SettingsSwitches.png}
   \includegraphics[scale=0.5]{2.3.0/switches.png}
...
\end{figure}
   ...
   \itempar{Include disabled data in XML files}{Main Settings!Include disabled
   data} Allows disabled data to be stored in the XML file.
...
%  \includegraphics[scale=0.75]{1.3.9/yoshimi-settings-jack.png}
   \includegraphics[scale=0.5]{2.3.0/jack.png}
...
%  \includegraphics[scale=0.75]{1.3.8/yoshimi-settings-alsa.png}
   \includegraphics[scale=0.5]{2.3.0/alsa.png}
...
%  \includegraphics[scale=0.75]{2.1.1/midi-cc.png}
   \includegraphics[scale=0.5]{2.3.0/midi.png}
...
%  \includegraphics[scale=0.75]{1.5.11/Settings_Pending.png}
   \includegraphics[scale=1.0]{2.3.0/midi_cc_pending.png}
...
%  Values: \texttt{Off*, On}
   ...
   From \textsl{Yoshimi} Version 2.3.0 one can change the colours of almost all parts of all windows. A slight variation of the original colours is now called 'classic', and this will always be available. There is also quite an extreme demonstration of what is possible.
...
\end{figure}
   ...
   \textbf{Installed Themes Menu} A click on an entry will immediately switch to that theme.

   \textbf{Import Theme} Themes can be found via the file manager and installed with this button. Any new themes one installs will show in the menu next time the window is refreshed.

   \textbf{Default Theme Display} Shows the name of the theme currently set as the default one.

    \textbf{Current Theme Display} Shows the currently selected theme (which may be different to the default).

   \textbf{Make Default} Sets the currently displayed theme as the new default one.
...
\label{subsubsec:menu_yoshimi_midi_learn}
   ...
   of its own.
   See \sectionref{sec:midi_learn}\hspace{4pt}for details.
...
\end{figure}
   ...
   \itempar{Make current presets}{Yoshimi Presets!Make Current}
