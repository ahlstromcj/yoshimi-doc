...
%  \includegraphics[scale=1.0]{1.5.0/About_1-5-1.png}
   \includegraphics[scale=0.8]{1.6.0/About.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{1.7.1/Contributors.png}
...
%  \includegraphics[scale=0.75]{1.4.1/SettingsMain.png}
   \includegraphics[scale=0.4]{2.2.0/SettingsMain.png}
...
%  \includegraphics[scale=0.75]{1.5.0/SettingsSwitches.png}
   \includegraphics[scale=0.75]{1.7.2/Settings_Switches.png}
...
%  \includegraphics[scale=0.75]{1.3.8/yoshimi-settings-alsa.png}
   \includegraphics[scale=0.90]{1.6.0/Settings_Alsa.png}
...
%  \includegraphics[scale=0.75]{2.1.1/midi-cc.png}
   \includegraphics[scale=0.5]{2.1.2/midi.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/SettingsChanged.png}
