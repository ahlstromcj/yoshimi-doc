...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{1.6.0/Contributors.png}
...
\end{figure}
   ...
   \textbf{Fixed} is the original arrangement, and activates the Alsa Midi Source control below.
   ...
   affect existing users, who will see it as 'Fixed' until such time as they change it themselves.
