...
\begin{figure}[H]
   \centering
   \includegraphics[scale=1]{2.0/MenuYoshimi.png}
   \caption[Yoshimi Menu, Exit]{Yoshimi Menu}
...
%  \includegraphics[scale=0.75]{1.5.11/Settings_Pending.png}
   \includegraphics[scale=0.5]{2.1.1/midi-cc-pending.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.0/SettingInUse.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{1.6.0/presets_dirs.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/NewPresetDir.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/LoadState.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/SaveState.png}
