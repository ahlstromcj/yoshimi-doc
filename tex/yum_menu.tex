...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{View Manual...} (not shown in the figure above)
      \item \textbf{Exit}
   \end{enumber}
...
%  (Alt-Y, Alt-I, Alt-P, and Alt-S) do not work (Yoshimi 1.3.5).
   ...
   currently requires that the \texttt{apvlv} (\cite{apvlv}) application be
   installed.
...
\begin{figure}[H]
   ...
   \caption[Yoshimi Menu, Exit]{Yoshimi Menu, View Manual}
