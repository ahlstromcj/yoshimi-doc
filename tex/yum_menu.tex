...
\end{figure}
   ...
   wavetable while it builds a new one, then notifes that it is ready to be applied.
...
\end{figure}
   ...
   controllers connected, but only those in a compartively congested MIDI
   setup.
...
\end{figure}
   ...
   against inavertently ovewriting it.
