...
\label{paragraph:menu_yoshimi_settings_main_settings}
   ...
   \figureref{fig:yoshimi_main_settings_dialog} below.
...
\end{figure}
   ...
   \itempar{OscilSize}{Main Settings!OscilSize}
...
\end{figure}
   ...
   \itempar{Save and Close}{Main Settings!Save and Close}
   This selection saves and closes the \textsl{Yoshimi} settings dialog.

   \itempar{Close Unsaved}{Main Settings!Close Unsaved}
   ...
   \textbf{Bug:}
   \index{bugs!Main Settings Close Unsaved}
...
\end{figure}
   ...
   \itempar{Save and Close presets}{Yoshimi Presets!Save and Close}
   Save and Close Presets.
   Press this button to save the changes.

   \itempar{Close Unsaved presets}{Yoshimi Presets!Close Unsaved}
   ...
   Please watch for this effect in all such dialogs; we're indexing such
   defects under the topic of "Bug" or "bugs".
...
\end{figure}
   ...
   \itempar{Save and Close}{JACK!Save and Close}
   Save and Close, JACK Settings.

   \itempar{Close Unsaved Jack}{JACK!Close Unsaved}
...
\end{figure}
   ...
   \itempar{Save and Close}{ALSA!Save and Close}
   Save and Close, ALSA Settings.

   \itempar{Close Unsaved Alsa}{ALSA!Close Unsaved}
...
\end{figure}
   ...
   \itempar{Enable Bank Root Change}{continuous controllers!enable bank root change}
   Enable Bank Root Change.

   Values: \texttt{Off*, On}

   \itempar{Bank Root Change}{continuous controllers!bank root change}
   Bank Root Change.
   ...
   \itempar{Bank Change}{continuous controllers!bank change}
   Bank Change.
   ...
   \itempar{Enable Program Change}{continuous controllers!enable program change}
   ...
   \itempar{Enable Part On Program Change}{continuous controllers!enable part change}
   ...
   \itempar{Enable Extended Program Change}{continuous controllers!enable extended change}
   Enable Extended Program Change.

   Values: \texttt{Off*, On}

   \itempar{Extended Program Change}{continuous controllers!extended change}
   ...
   \itempar{Save and Close}{continuous controllers!Save and Close}
   Save and Close, Continuous Constrollers Settings.

   \itempar{Close Unsaved CC}{continuous controllers!Close Unsaved}
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=1.0]{menu/yoshimi-menu-instrument.jpg}
...
\end{figure}
   ...
   \textbf{Add to Favorites} \index{Add to Favorites}
...
% TODO:  The name of this dialog file should be show_instruments.png.

\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.75]{1.3.5/show_banks.png}
   \caption[Show Instruments]{Show Instruments, 1.3.5 and Above}
   \label{fig:show_instruments}
\end{figure}

   As \figureref{fig:show_instruments}
...
% This figure should be updated for Yoshimi 1.3.5:
%  \includegraphics[scale=0.75]{menu/Instrument/show-CA-bank.jpg}

\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.75]{1.3.5/show-CA-banks.jpg}
...
\end{figure}
   ...
   Please refer to 
   \figureref{fig:show_instruments} as well.
   ...
   \itempar{Bank Name}{instruments!bank name}
...
\end{figure}
   ...
   We're not yet sure where the numbers in the dropdown list come from; they
   must be automatically generated.
   TODO:  Find out!

   Selecting one of the items in this dropdown list selects the bank and
   loads it into the Banks dialog.

   \itempar{Refresh banks}{instruments!refresh banks}
   ...
   \itempar{Instruments}{instruments!instruments}
   Instruments Button.
   ...
   \textbf{Bug:}
   \index{bugs!click on rename bank closes Yoshimi}
   ...
   \itempar{Show PADsynth status}{instruments!PADsynth status}
   Instruments Show PADsynth Status.

   TODO:  Describe/summarize  each dialog flavor properly distinguished.
...
\label{subsubsec:menu_instrument_show_banks}
   ...
   As shown in
   \figureref{fig:show_banks_directories},
   the banks dialog uses most of the same
   user-interface elements as the instruments dialog shown in
   \figureref{fig:show_ca_bank}.

\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.75]{menu/Instrument/show-banks-directories.jpg}
...
\end{figure}
   ...
   TODO: We need to know more about how this ID can be used.
   Is it a way to make the path selectable via an extended MIDI control, or
   some other automation method?

   \itempar{Save and Close}{Root Paths!save and close}
   Show Root Paths Save and Close.

   \itempar{Close Unsaved Root Paths}{Root Paths!close unsaved}
   Show Root Paths Close Unsaved.

   \textbf{Bug:}
   \index{bugs!root paths closed unsaved}
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=1.0]{menu/yoshimi-menu-scales.jpg}
...
\label{paragraph:menu_scales_keyboard_mapping}
   ...
   One can enable the mapping by pressing the \texfbf{ON} check-box.
