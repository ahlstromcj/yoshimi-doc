...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{1.7.1/Contributors.png}
...
%  back all the settings that were previously used for that instance.
   ...
   \textsl{Yoshimi}'s configuration directory more tidy. These entries are also
   hidden when \textsl{Yoshimi} is being used as an LV2 plug as they are not
   relevant at all in that environment.
...
\end{figure}
   ...
   found that with very low resolution screems and some window managers
