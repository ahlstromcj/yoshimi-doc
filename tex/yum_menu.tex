...
%  \includegraphics[scale=0.75]{menu/Yoshimi/yoshimi-settings-main.jpg}
   \includegraphics[scale=0.75]{1.3.6/yoshimi-settings-main.png}
...
%  \includegraphics[scale=0.75]{menu/Yoshimi/yoshimi-settings-alsa.jpg}
   \includegraphics[scale=0.75]{1.3.6/yoshimi-settings-alsa.png}
...
%  \includegraphics[scale=0.75]{menu/Yoshimi/yoshimi-settings-ccs.jpg}
   \includegraphics[scale=0.75]{1.3.6/yoshimi-settings-midi.png}
...
\end{figure}
   ...
   \itempar{Save and Close}{MIDI preferences!Save and Close}
   Save and Close, Continuous Constrollers Settings.

   \itempar{Close Unsaved CC}{MIDI preferences!Close Unsaved}
...
\end{figure}
   ...
   \itempar{Refresh banks}{obsolete!refresh banks}
   Instruments Refresh Banks.  OBSOLETE.
   ...
   \itempar{New Bank}{obsolete!new bank}
