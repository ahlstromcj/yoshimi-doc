...
\end{figure}
   ...
   The exact meaning of this option is TO BE DETERMINED.
...
%  TODO:  Could add a figure showing the red Pending button.
   ...
   This result seems counter-intuitive.

   It is not clear if "pending" changes persist after \textsl{Yoshimi} closes,
   or if the session or state must be saved.
...
\end{figure}
   ...
   \textbf{Bug:}
   \index{bugs!States, recent states dialog}
   HOWEVER, at this time, the Recent States dialog does not come up, at all.
