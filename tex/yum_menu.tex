...
\end{figure}
   ...
   \sectionref{subsubsec:menu_yoshimi_vectors}, which presents this dialog and
...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{Hide Non Fatal Errors} (moved to 'Switches')
      \item \textbf{Log XML headers} (moved to 'Switches')
      \item \textbf{Show Splash} (new) (moved to 'Switches')
   \end{enumber}
