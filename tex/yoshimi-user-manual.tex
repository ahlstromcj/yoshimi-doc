...
\begin{document}
\title{Yoshimi Advanced Reference Manual, v 2.1.0}
\author{Chris Ahlstrom \texttt{(ahlstromcj@gmail.com)} with Will J. Godfrey}
\date{\today}
\maketitle
\begin{center}(transitional)\end{center}
\begin{figure}[H]
   \centering
   \includegraphics[scale=1.00]{2.0/Front.png}
\end{figure}
...
\label{subsubsec:new_features_miscellany}
   ...
   \textsl{Yoshimi}. However, see \sectionref{subsec:file_compatibility}
...
\label{subsec:file_compatibility}
   It is always a challenge with developing software to make impovements to
...
\index{new!Yoshimi/ZynAddSubFX Warning}
   ...
   a warning as shown in \figureref{fig:compatibilty_warning}.
...
\begin{figure}[H]
   ...
   \label{fig:compatibilty_warning}
\end{figure}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=1.0]{2.0/Front.png}
