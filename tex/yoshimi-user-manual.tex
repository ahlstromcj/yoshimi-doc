...
\title{A Yoshimi 1.3.6 User Manual}
...
\label{subsec:introduction_yoshimi_vs_zyn}
   ...
   same patch.  It also has comprehensive audio effects modules.
   ...
   \textsl{Yoshimi} has a cleaner graphical user interface.
...
\subsection{Yoshimie Mailing List}
\label{subsec:introduction_mailing_list}

   The \textsl{Yoshimi} project used to have an email list at SourceForge,
   but the unreliability of the site has prompted a move to a new
   mailing list.  See reference \cite{yoshiminews}.
   The team have managed to port across all the old yoshimi-user archives to
   this new site.  See reference \cite{yoshiminewsarchive}.
