...
\begin{document}
\title{Yoshimi Advanced User Manual, v 1.6.0}
...
%  In the case of sliders not the peg itself.
   ...
   no X server. The command \texttt{/usr/share/bin/yoshimi -A -i}
   worked perfect.y and auto-connected the keyboard.
   Since version 1.5.11 it one can provide
