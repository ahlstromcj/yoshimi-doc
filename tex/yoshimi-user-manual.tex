...
\label{subsubsec:new_features_midi_cc}
   ...
   At the request of one user, \textsl{Yoshimi} has an
...
\label{subsubsec:new_features_bank_support}
   ...
   doesn't in fact have to be \texttt{banks}, but that is tradition.
...
%  , but can't yet deal with the individual effects controls.
