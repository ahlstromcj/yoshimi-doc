...
% Make a shorter reference to a figure using its number, and its name.
% Very useful if you have a hard-copy of the document to deal with.

\newcommand{\figref}[1] {
   Figure~\ref{#1}
   "\nameref{#1}"\ignorespaces
}
...
% Make a partial reference to a section using its number and its name.
% Very useful if you have a hard-copy of the document to deal with.
