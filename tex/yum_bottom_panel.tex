...
\begin{figure}[H]
   \centering
   \includegraphics[scale=1.0]{2.3.0/controllers.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.3.0/aftertouch.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=1.0]{2.3.0/midiCCs.png}
...
%  \includegraphics[scale=1.0]{2.0/PartEdit.png}
   \includegraphics[scale=0.5]{2.3.0/edit.png}
