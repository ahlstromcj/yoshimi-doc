...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{1.6.0/Scales.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/ImportScala.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/ImportKeymap.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/LoadScale.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/LoadsclFailed.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/RecentScales.png}
