...
\label{subsec:configuration_patch_set}
   ...
   \textbf{Parameters / Save} menu entry saves files with this extension.  This
   file used to be called \textsl{parameter set}, but that name is no longer
   used in \textsl{Yoshimi}..
