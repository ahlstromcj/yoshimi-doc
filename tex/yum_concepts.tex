...
\label{subsec:concepts_banks_and_roots}
   ...
   collection of banks.
   Recently, \textsl{Yoshimi} has adopted the name \textsl{path} instead of
...
\subsubsection{Concepts / Sessions / Management}
\label{subsec:concepts_sessions_management}
   ...
   managers it looks like they don't want (or can't use) most of the
   ...
   but would anyone want to do so from a session manager?
