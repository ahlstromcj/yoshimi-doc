...
% Reverb
    \textsl{command line entry for} Reverb:  '? rev'
   \begin{table}[H]
      \centering
      \caption{Reverb}
      \begin{tabular}{l l}
...
\pagebreak
% Echo
    \textsl{command line entry for} Echo:  '? ech'
   \begin{table}[H]
      \centering
      \caption{Echo}
      \begin{tabular}{l l}
...
\pagebreak
% Chorus
    \textsl{command line entry for} Chorus:  '? cho'
   \begin{table}[H]
      \centering
      \caption{Chorus}
      \begin{tabular}{l l}
...
\pagebreak
% Phaser
   \textsl{command line entry for} Phaser:  '? pha'
   \begin{table}[H]
      \centering
      \caption{Phaser}
      \begin{tabular}{l l}
...
\pagebreak
% Alienwah
   \textsl{command line entry for} AlienWah:  '? ali'
   \begin{table}[H]
      \centering
      \caption{Alienwah}
      \begin{tabular}{l l}
...
\pagebreak
% Distortion
   \textsl{command line entry for} Distortion:  '? dis'
   \begin{table}[H]
      \centering
      \caption{Distortion}
      \begin{tabular}{l l}
...
% EQ
   \textsl{command line entry for} EQ:  '? eq'
   \begin{table}[H]
      \centering
      \caption{EQ}
      \begin{tabular}{l l}
...
\pagebreak
% DynFilter
   \textsl{command line entry for} DynFilter:  '? dyn'
   \begin{table}[H]
      \centering
      \caption{Dynfilter}
      \begin{tabular}{l l}
