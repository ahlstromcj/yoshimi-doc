...
\label{sec:effects}
   ...
   that applies to each parts. Also, it is possible to send the output of
   one system effect to other system effects. In the user interface this is
   shown as "source -\textless destination". eg. "0 -\textless 1" means how
...
\label{subsec:effects_paneltypes}
   ...
   \begin{itemize}
      \item \textbf{System Effects} sub-panel.
      \item \textbf{Insertion Effects} sub-panel.
      \item \textbf{Part/Instrument Effects} sub-panel.
   \end{itemize}
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=1.0]{effects-panel/system-effects.jpg}
...
% \begin{figure}[H]
%    \centering 
%    \includegraphics[scale=1.0]{effects-panel/insertion-effects.jpg}
...
% \begin{figure}[H]
%    \centering 
%    \includegraphics[scale=1.0]{effects-panel/insertion-effects-to-part.jpg}
...
%  instruments-effects-panel.png (or, less nice part-window-effects.png)
...
%  FOURTH SUBSECTION?
%
%  There is a fourth type I have screen captures for, but I can't get
%  to them now!  Are these now out-of-date screen captures?
%  The ????? variation adds the following elements:
%
%  \begin{enumber}
%     \item \textbf{FX No.}
%     \item \textbf{bypass}
...
% This version is too simplistic and old:
%
% \begin{figure}[H]
%    \centering 
%    \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/dynfilter-parameters.jpg}
%    \caption{DynFilter Parameters}
%    \label{fig:effects_edit_dynfilter_parameters}
% \end{figure}
