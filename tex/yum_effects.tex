...
\end{figure}
   ...
   TODO: What about "Instrument Effects" mentioned in a version of the
   manual?
   \index{todo!instrument effects}
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=1.0]{effects-panel/system-effects-C-clipboard.jpg}
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=1.0]{effects-panel/system-effects-P-clipboard.jpg}
