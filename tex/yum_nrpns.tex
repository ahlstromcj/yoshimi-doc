...
is to be handled.
   ...
   \begin{table}[H]
      ...
      \begin{tabular}{r r c l l l}
\textbf{NRPN LSB} & \textbf{DATA MSB} & \textbf{DATA LSB} & \textbf{Type} & \textbf{Settings} \\
        0 & part & index     & Instrument &  0 to 63 & 0 to 24 \\
        1 & 0 & index        & Patch Set  & 0        & 0 to 24 \\
        2 & 0 & index        & Scale      & 0        & 0 to 24 \\
        3 & 0 & index        & State      & 0        & 0 to 24 \\
        4 & channel & index   & Vector    & 0 to 15  & 0 to 24 \\
        5 & 0 & index        & Midi Learn & 0        & 0 to 24 \\
      \end{tabular}
   \end{table}
