...
%  \includegraphics[scale=1.0]{1.5.0/AddSynth.png}
   \includegraphics[scale=1.0]{1.7.2/AddSynth.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{1.7.2/AddVoice.png}
...
% TODO FOR 1.6.0: Uncomment the commented text.
  ...
  only imports the waveform, not any other parameters.
   ...
   Values: \texttt{-90, 0*, 88.6 to 360 (degrees)}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{1.6.1/Oscillator.png}
