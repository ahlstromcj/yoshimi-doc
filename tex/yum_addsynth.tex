...
\label{sec:addsynth}
   ...
   oscillator and the \index{modulation oscillator} modulation oscillator.
   ...
   In the voice window, the \textbf{Oscillator Source} gives the choice of
...
%  \includegraphics[scale=0.75]{1.4.0/ADDsynth-voice-parameters.png}
%  \includegraphics[scale=0.75]{1.5.0/AddVoice.png}
%  \includegraphics[scale=0.75]{1.5.7/AddVoice.png}
   \includegraphics[scale=0.75]{1.5.7/AddVoice-DocuVoice.png}
...
\end{figure}
   ...
   This is all in synchrony with the \textbf{Kit Edit} window.
...
\end{figure}
   ...
   \itempar{Mod Oscillator Use}{modulator!external}
   Mod Oscillator.
   ...
   This value must indicate a voice with a number less than the current voice.
   Entries are greyed out for Voice 1, as there is no lower-numbered voice
...
\label{subsubsec:addsynth_voice_parameters_oscillator}
   ...
   "Mod n", where "n" is the coice number.
...
%  \includegraphics[scale=0.75]{1.5.0/AddSynthVoiceList.png}
   \includegraphics[scale=0.75]{1.5.7/AddSynthVoiceList.png}
