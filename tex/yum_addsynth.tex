...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{PM}
         ...
         envelope to change the pulse of the voice oscillator. It produces a
...
\label{subsec:addsynth_voice-warning}
   ...
   the waveform window, until now there was no indication that one was likely
   to change a shared oscillator. This is put right since V 1.5.11 and it also
   applies to modulator waveforms.
