...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/LoadPatchset.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/SavePatchset.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.0/NothingToSave.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{2.0/BankRootPaths.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.8]{2.0/NewBankRoot.png}
