...
\label{subsubsec:menu_patch_sets}
   ...
   The patch set saves all of the settings, including effects and
   instruments.
...
\end{figure}
   ...
   described in the
   \sectionref{subsubsec:menu_instrument_show} discussion.
...
\end{figure}
   ...
   includes Master Volume and Detune, Part destinations, Humanise, and more.
