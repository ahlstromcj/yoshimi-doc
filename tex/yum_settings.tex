...
\label{subsubsec:stock_settings_elements_sliders}
   ...
   move it slightly, the peg will go to it's default position. the same
   will happen if you click on the track with the right button.
...
\end{figure}
   ...
   \index{todo!preset file question}
