...
\label{subsec:command_line_command_synth_engines}
   ...
   Starting at the part level prompt:
   ...
   Kit item 4 hasn't yet been enabled so let's enable it and turn on the
   ...
   These new controls are show in the part context help list.
