...
\label{subsec:command_line_command_scripts}
   ...
   number of the line where the error occurred. Due to the buffering used,
   the script will return before many of the actions have actually taken place.
   ...
   Blank lines are ignored and '\#' at the start of a line marks it
   as a comment so will also be ignored. However, both of these will
...
\label{paragraph:command_line_context_levels}
   ...
   There are a few commands that set the context or command level, where additional commands
