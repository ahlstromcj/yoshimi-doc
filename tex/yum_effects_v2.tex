...
\end{figure}
   ...
   experementally switch to different presets or even different effects.
...
%  TODO: Barber is deactivated, since PLFOtype is only 0 or 1?
   ...
   \begin{enumber}
      ...
      \item Next, this is modulates the input signal amplitude.
      \item The \textbf{Analog} setting decides whether the phaser is analog
            or "normal".
            For the analog phaser (see the \textbf{Analog} check-box), LFO
            \textbf{Phase} is not implemented, nor is \textbf{L/R}.
