...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.5]{2.2.0/system.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=1.0]{2.0/SystemEffectsSendTo.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{1.6.0/Effect_Copy}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.75]{1.6.0/Effect_Paste}
...
%   \includegraphics[scale=1.0]{2.1.0/insertion_effect_example.png}
   \includegraphics[scale=0.5]{2.2.0/insertion.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.6]{2.1.0/sample_part_effect.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.5]{2.1.0/none.png}
   \caption{Effects Edit, No Effect}
...
%  \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/effects-edit-dynfilter.jpg}
   \includegraphics[scale=0.5]{2.1.0/dynfilter.png}
...
%  \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/effects-edit-alienwah.jpg}
   \includegraphics[scale=0.5]{2.1.0/alienwah.png}
...
\label{subsec:effects_edit_chorus}
   ...
   these different timbres ourselves. ZynAddSubFX therefore simply plays
...
%  \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/effects-edit-chorus.jpg}
   \includegraphics[scale=0.5]{2.1.0/chorus.png}
...
%  \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/effects-edit-distortion.jpg}
   \includegraphics[scale=0.5]{2.1.0/distortion.png}
...
%  \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/effects-edit-echo.jpg}
   \includegraphics[scale=0.5]{2.1.0/echo.png}
...
%  \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/effects-edit-eq.jpg}
   \includegraphics[scale=0.5]{2.1.0/eq.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.5]{2.1.0/phaser.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.4]{2.1.0/phaser-presets.png}
...
%  \includegraphics[scale=1.0]{bottom-panel/instrument-edit/Effects/effects-edit-reverb.jpg}
   \includegraphics[scale=0.5]{2.1.0/reverb.png}
